...
import (
	propertydomain "tax_calculator/engine/internal/domains/hmrc_domain/property_domain"
	selfemploymentdomain "tax_calculator/engine/internal/domains/hmrc_domain/self_employment_domain"
)
